...
public class Inet {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("내 콤퓨타 명 : " + localIp.getHostName());
            System.out.println("내 콤퓨타 주소 : " + localIp.getHostAddress());

            InetAddress naverIp = InetAddress.getByName("www.naver.com"); // dns 주소를 활용해서 ip 주소를 변환
