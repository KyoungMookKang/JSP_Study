...
public class BoardDao {
    public BoardDto selectOne(int no1) {
        System.out.println("BoardDao : selectOne no : " + no1); //1차확인
        BoardDto rsDto = null;
        ...
        try {
            ...
            String sql = "SELECT * FROM BBS7 WHERE NO = ?";
            ...
            if (rs.next()) {
                ...
                rsDto.setContent(rs.getString("TEL"));
                rsDto.setWriter(rs.getInt("CONTENT"));
            }
